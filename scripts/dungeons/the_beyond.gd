...
static var ID: String = "TheBeyond"
...
func generate_enemies() -> void:
	...
	# generate boss
	boss_list.clear()
	boss_list.append(MonsterHelper.BOSS_LEVEL3_AWAKENED_ONE)
	boss_list.append(MonsterHelper.BOSS_LEVEL3_DONU_AND_DECA)
	boss_list.append(MonsterHelper.BOSS_LEVEL3_TIME_EATER)